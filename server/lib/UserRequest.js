...
* @param {number} body.hmiAddressInternal - The actual address of sdl_core's websocket address
* @param {string} body.startTime - The date when this user object is created
*/
